...
var http = config.env === 'dev' ? require('http') : require('https');
...
var HttpWrapper = /*#__PURE__*/function () {
  function HttpWrapper(options) {
    ...
    if (this._options.headers) this._options.headers['x-mdb-cli-version'] = packageJson.version;else this._options.headers = {
