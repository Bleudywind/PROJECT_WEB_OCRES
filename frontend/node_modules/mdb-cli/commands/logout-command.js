...
var LogoutHandler = require('../utils/logout-handler');

var AuthHandler = require('../utils/auth-handler');

var LogoutCommand = /*#__PURE__*/function (_Command) {
  _inherits(LogoutCommand, _Command);

  var _super = _createSuper(LogoutCommand);
  ...
  function LogoutCommand() {
    ...
    _this.handler = new LogoutHandler(authHandler);
  ...
  _createClass(LogoutCommand, [{
    ...
    value: function execute() {
      ...
      return this.handler.logout().then(function () {
        return _this2.print();
      })["catch"](function (e) {
