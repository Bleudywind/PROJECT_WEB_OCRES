...
var ListHandler = require('../utils/list-handler');
...
var ListCommand = /*#__PURE__*/function (_Command) {
  ...
  function ListCommand() {
    ...
    _this.options.path = '/packages/read';
    _this.options.method = 'GET';
    _this.options.data = '';
    _this.handler = new ListHandler(authHandler);
  ...
  _createClass(ListCommand, [{
    ...
    value: function execute() {
      ...
      return this.handler.fetchProducts().then(function () {
        return _this2.print();
      })["catch"](function (e) {
