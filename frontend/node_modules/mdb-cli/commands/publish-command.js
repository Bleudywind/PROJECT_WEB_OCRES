...
var PublishCommand = /*#__PURE__*/function (_Command) {
  ...
  function PublishCommand() {
    ...
    _this.handler = new PublishHandler(authHandler);
  ...
  _createClass(PublishCommand, [{
    ...
    value: function execute() {
      ...
      return this.handler.setArgs(this.args).then(function () {
        return _this2.handler.handlePublishArgs();
      }).then(function () {
        return _this2.handler.runTests();
      }).then(function () {
        return _this2.handler.setProjectName();
      }).then(function () {
        return _this2.handler.publish();
      }).then(function () {
        return _this2.print();
      })["catch"](function (e) {
