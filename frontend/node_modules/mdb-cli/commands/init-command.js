...
var InitHandler = require('../utils/init-handler');
...
var InitCommand = /*#__PURE__*/function (_Command) {
  ...
  function InitCommand() {
    ...
    _this.handler = new InitHandler(authHandler);
  ...
  _createClass(InitCommand, [{
    ...
    value: function execute() {
      ...
      return this.handler.getAvailableOptions().then(function () {
        return _this2.handler.showUserPrompt();
      }).then(function () {
        return _this2.handler.initProject();
      }).then(function () {
