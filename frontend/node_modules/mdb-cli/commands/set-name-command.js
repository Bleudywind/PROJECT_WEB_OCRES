...
var SetNameCommand = /*#__PURE__*/function (_Command) {
  _inherits(SetNameCommand, _Command);

  var _super = _createSuper(SetNameCommand);
  ...
  function SetNameCommand() {
    ...
    _classCallCheck(this, SetNameCommand);

    _this = _super.call(this, authHandler);
    _this.handler = new SetNameHandler(authHandler);
    return _this;
  }

  _createClass(SetNameCommand, [{
    key: "execute",
    value: function execute() {
      var _this2 = this;

      this.handler.setArgs(this.args);
      return this.handler.askForNewProjectName().then(function () {
        return _this2.handler.setName();
      }).then(function () {
        return _this2.print();
      })["catch"](function (e) {
